...
│  └──YYYYMM/                          # output from build_interactive_stack.py
│     ├──stacked_keograms_YYYYMM.png   # output from stack_keograms.py
│     ├──keogram_YYYYMM.html           # output from build_stack_html.py
...
│  └──YYYY/
│     └──MM/
│        └──overlaid_full/YYYY/MM/YYYYMMDD_overlay_streaming.png
├──overlaid_partial/                   # outputs from create_keogram_plots.py (partial)
│  └──YYYY/
│     └──MM/
│        └──overlaid_partial/YYYY/MM/YYYYMMDD_hHS-HE_overlay_streaming.png
├──stacked_by_month/                   # outputs from stack_keograms.py
│  └──YYYYMM/                          
│     └──stacked_keograms_YYYYMM.png 
